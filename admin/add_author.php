	...
	<div class="row">
		...
		<div class="col-md-4">
			<form action="" method="post">
				...
				<button class="btn" style="background-color: #964B00; color:white" name="add_author">Add Author</button>
...
<?php
	if(isset($_POST['add_author'])){
		$stmt = mysqli_prepare($connection, "INSERT INTO authors (author_id, author_name) VALUES (NULL, ?)");
