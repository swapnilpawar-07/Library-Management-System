	...
	<div class="row">
		...
		<div class="col-md-4">
			<form action="" method="post">
				...
				<button class="btn" style="background-color: #964B00; color:white" name="add_book">Add Book</button>
...
<?php
	if(isset($_POST['add_book'])){
		$stmt = mysqli_prepare($connection, "INSERT INTO books (book_id, book_name, author_id, cat_id, book_no, book_price) VALUES (NULL, ?, ?, ?, ?, ?)");
		mysqli_stmt_bind_param($stmt, "siiii", $_POST['book_name'], $_POST['author_id'], $_POST['cat_id'], $_POST['book_no'], $_POST['book_price']);
