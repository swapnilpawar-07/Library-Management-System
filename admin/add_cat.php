	...
	<div class="row">
		...
		<div class="col-md-4">
			<form action="" method="post">
				...
				<button class="btn" style="background-color: #964B00; color:white" name="add_cat">Add Category</button>
...
<?php
	if(isset($_POST['add_cat'])){
		$stmt = mysqli_prepare($connection, "INSERT INTO category (cat_id, cat_name) VALUES (NULL, ?)");
		mysqli_stmt_bind_param($stmt, "s", $_POST['cat_name']);
