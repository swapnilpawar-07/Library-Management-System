	...
	<div class="row">
		<div class="col-md-3">
			<div class="card " style="width: 300px; background-color: #fcfbf7">
				...
				<div class="card-body">
					<p class="card-text">No. of total users registered: <?php echo get_user_count($connection);?></p>
		...
		<div class="col-md-3">
			<div class="card " style="width: 300px; background-color: #fcfbf7">
				...
				<div class="card-body">
					<p class="card-text">No. of availbale books: <?php echo get_book_count($connection);?></p>
		...
		<div class="col-md-3">
			<div class="card " style="width: 300px; background-color: #fcfbf7">
				...
				<div class="card-body">
					<p class="card-text">No. of book's category: <?php echo get_category_count($connection);?></p>
		...
		<div class="col-md-3">
			<div class="card " style="width: 300px; background-color: #fcfbf7">
				...
				<div class="card-body">
					<p class="card-text">No. of book's authors: <?php echo get_author_count($connection);?></p>
		...
		<div class="col-md-3">
			<div class="card " style="width: 300px; background-color: #fcfbf7">
				...
				<div class="card-body">
					<p class="card-text">No. of issued books: <?php echo get_issued_book_count($connection);?></p>
