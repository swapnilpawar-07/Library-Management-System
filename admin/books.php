<?php
	...
	$price = "";
	$cat_id = "";
	$query = "select books.book_name,books.cat_id,books.book_no,books.book_price,authors.author_id from books left join authors on books.author_id = authors.author_id";
?>
<!DOCTYPE html>
<html>
<head>
