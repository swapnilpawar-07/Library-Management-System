<?php
	...
	$stmt = mysqli_prepare($connection, "SELECT * FROM authors WHERE author_id = ?");
		...
		<div class="col-md-4">
			<form action="" method="post">
				<div class="form-group">
					...
					<input type="text" name="author_name" value="<?php echo htmlspecialchars($author_name);?>" class="form-control" required="">
				</div>
				<button class="btn" style="background-color: #964B00; color:white" name="update">Update Author</button>
...
<?php
	if(isset($_POST['update'])){
		$update_stmt = mysqli_prepare($connection, "UPDATE authors SET author_name = ? WHERE author_id = ?");
		mysqli_stmt_bind_param($update_stmt, "si", $_POST['author_name'], $_GET['aid']);
