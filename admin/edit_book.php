<?php
	...
	$stmt = mysqli_prepare($connection, "SELECT * FROM books WHERE book_no = ?");
	...
	<div class="row">
		...
		<div class="col-md-4">
			<form action="" method="post">
				...
				<button class="btn" style="background-color: #964B00; color:white" name="update">Update Book</button>
...
<?php
	if(isset($_POST['update'])){
		$update_stmt = mysqli_prepare($connection, "UPDATE books SET book_name = ?, author_id = ?, cat_id = ?, book_price = ? WHERE book_no = ?");
		mysqli_stmt_bind_param($update_stmt, "siiii", $_POST['book_name'], $_POST['author_id'], $_POST['cat_id'], $_POST['book_price'], $_GET['bn']);
