<?php
	...
	$stmt = mysqli_prepare($connection, "SELECT * FROM category WHERE cat_id = ?");
		...
		<div class="col-md-4">
			<form action="" method="post">
				<div class="form-group">
					...
					<input type="text" name="cat_name" value="<?php echo htmlspecialchars($cat_name);?>" class="form-control" required="">
				</div>
				<button class="btn" style="background-color: #964B00; color:white" name="update">Update Category</button>
...
<?php
	if(isset($_POST['update'])){
		$update_stmt = mysqli_prepare($connection, "UPDATE category SET cat_name = ? WHERE cat_id = ?");
		mysqli_stmt_bind_param($update_stmt, "si", $_POST['cat_name'], $_GET['cid']);
