	...
	<div class="row">
		...
		<div class="col-md-4">
			<form action="" method="post">
					...
					<select class="form-control" name="book_author">
						...
						<?php
							...
							while($row = mysqli_fetch_assoc($query_run)){
								?>
								<option><?php echo htmlspecialchars($row['author_name']);?></option>
								<?php
							}
						?>
					</select>
				...
				<button class="btn" style="background-color: #964B00; color:white" name="issue_book">Issue Book</button>
...
<?php
	if(isset($_POST['issue_book'])){
		$stmt = mysqli_prepare($connection, "INSERT INTO issued_books (s_no, book_no, book_name, book_author, student_id, status, issue_date) VALUES (NULL, ?, ?, ?, ?, 1, ?)");
