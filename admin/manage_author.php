				...
				<?php
					...
					while($row = mysqli_fetch_assoc($query_run)){
						...
						<tr>
							...
							<td>
								<button class="btn" name=""><a href="edit_author.php?aid=<?php echo urlencode($row['author_id']);?>">Edit</a></button>
								<button class="btn" name=""><a href="delete_author.php?aid=<?php echo urlencode($row['author_id']);?>">Delete</a></button>
							</td>
						</tr>
						<?php
					}
