	...
	<div class="row">
		...
		<div class="col-md-4">
			<form action="update.php" method="post">
				...
				<div class="form-group">
					<label>Email:</label>
					<input type="text" class="form-control" value="<?php echo htmlspecialchars($email);?>" name="email">
				</div>
				<div class="form-group">
					<label>Mobile:</label>
					<input type="text" class="form-control" value="<?php echo htmlspecialchars($mobile);?>" name="mobile">
				</div>
				<div class="form-group">
					<label>Address:</label>
					<textarea rows="3" cols="40" name="address" class="form-control"><?php echo htmlspecialchars($address);?></textarea>
				</div>
				<button  type="submit" name="update" class="btn" style="background-color: #964B00; color:white">Update</button>
			</form>
		</div>
		<div class="col-md-4"></div>
	</div>
