<?php
	...
	function get_user_issue_book_count($connection){
		...
		$stmt = mysqli_prepare($connection, "SELECT COUNT(*) as user_issue_book_count FROM issued_books WHERE student_id = ?");
	...
	<div class="row">
		<div class="col-md-3">
			<div class="card bg-light" style="width: 300px">
				...
				<div class="card-body">
					<p class="card-text">No. of Issued Books: <?php echo get_user_issue_book_count($connection);?> </p>
